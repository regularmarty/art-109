...
(function (root, factory) {
    ...
    var leftArrow = '<svg width="44" height="60">' +
        ...
        rightArrow = '<svg width="44" height="60">' +
            '<polyline points="14 10 34 30 14 50" stroke="rgba(231, 19, 19, 0.5)" stroke-width="4"' +
              'stroke-linecap="butt" fill="none" stroke-linejoin="round"/>' +
            '</svg>',
        closeX = '<svg width="30" height="30">' +
            '<g stroke="rgba(227, 21, 21, 1)" stroke-width="4">' +
    ...
    var options = {},
        defaults = {
            ...
            afterHide: null,
            onChange: null,
            overlayBackgroundColor: 'rgba(0, 112, 99, 0.8)',
            closeX: closeX,
            leftArrow: leftArrow,
